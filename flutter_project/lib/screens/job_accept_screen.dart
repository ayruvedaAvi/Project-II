...
class JobAcceptScreen extends StatefulWidget {
  ...
  @override
  State<JobAcceptScreen> createState() => _JobAcceptScreenState();
}

class _JobAcceptScreenState extends State<JobAcceptScreen> {
